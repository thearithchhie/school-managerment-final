...
<div class="box bb-3 border-warning">
  ...
  <div class="row">  <!-- start 1st row -->
   ...
   <img src="{{ url('image/logo.png') }}" style="width: 120px; height: 100px; object-fit: contain">
  		</div>
        ...
        <div class="col-md-2 text-center">
  		...
  		<div class="col-md-4 text-center" style="float: left;">
  			<h4><strong>School SQ5</strong></h4>
  			<h6><strong>Phnom Penh, Cambodia</strong></h6>
  			<h5><strong><u>Academic Transcript</u></strong></h5>
